...
public class PercentageBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //canvas.rotate(90);
        // canvas.rotate(-90 ,measuredHeight/2 ,measuredHeight/2);
        /**
         * 画柱状图
         */
        for(int i = 0 ; i<totalBarNum ; i++){
            ...
            canvas.drawText(respName.get(i),startX,startY+deltaY+i*(deltaY+barWidth)+barWidth/4, mTextPaint);
            canvas.drawRect(startX+mTextPaint.measureText(respName.get(i)), startY+deltaY+i*(deltaY+barWidth), currentBarProgress[i], startY+deltaY+i*(deltaY+barWidth)+barWidth, mBarPaint);
        }
        /**
         * 画竖线
         */
